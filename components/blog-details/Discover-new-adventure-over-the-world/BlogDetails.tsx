      ...
      <div className="container">
        <div className="cs-blog-detail">
          <div className="blog-details_heading text-center mt-4 mb-4">
            <h2>Discover new adventures over the world</h2>
          </div>
        </div>
      </div>
          ...
          <div className="blog_inner">
            <article className="mainBlog">
              ...
              <p>
                ...
                abhorrent as house with between ouch that well scurrilously alas
                capybara massive outdid oh said hello majestically roadrunner
                lobster much bled alas lighted together waved upheld more far
                woolly ahead darn far far bore far far saw baneful upset rebound
                bowed possessive before or indisputably against.
              </p>
              ...
              <p>
                ...
                abhorrent as house with between ouch that well scurrilously alas
                capybara massive outdid oh said hello majestically roadrunner
                lobster much bled alas lighted together waved upheld.
              </p>
